...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        path = '/media/liuyu/ext4(version 1.0/lhh/SINetV2-gai/SINet-V2-4stage (3rd copy)/pvt_v2_b2.pth'
    ...
    def forward(self, x):
        ...
        # backbone
        pvt = self.backbone(x)
        # print("pvt:", pvt[0].shape)
        x1 = pvt[0]
        # print(x1.size()) #[1, 64, 88, 88]
        x2 = pvt[1]
        x3 = pvt[2]
        x4 = pvt[3]
        # print(x1.size())
